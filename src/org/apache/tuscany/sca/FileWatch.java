...
public class FileWatch {
    ...
    private static void fileWatch() throws Exception {
        ...
        //目录观察者
        FileAlterationObserver observer = new FileAlterationObserver(new File("domain"),new FileFilter() {
        ...
        observer.addListener(new FileAlterationListener() {
            ...
            public void onFileCreate(File file) {
                ...
                if(file.getPath().indexOf(".jar")>-1){
                    autoDeploy.addJar(file.getPath());
                }
            }
    ...
    private static void watch() throws Exception
    {
        ...
        Paths.get("domain").register(watchService,
